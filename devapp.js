jQuery.sap.declare("TestCamAndLoc.devapp");
jQuery.sap.require("TestCamAndLoc.devlogon");

TestCamAndLoc.devapp = {
	smpInfo: {},
	//the variable hold TestCamAndLoc.devlogon instance
	devLogon: null,
		...
		if (window.sap_webide_FacadePreview) {
			...
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new TestCamAndLoc.devlogon();
